...
var cargar_informatica = new Informatica("pc componentes");
...
var Programa = function () {
    var _classDecorators = [arranque("Lanzamiento del curso de nodejs")];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var Programa = _classThis = /** @class */ (function () {
        function Programa_1() {
        }
        Programa_1.prototype.setNombre = function (nombre) {
            this.nombre = nombre;
        };
        Programa_1.prototype.getNombre = function () {
            return this.nombre;
        };
        Programa_1.prototype.setVersion = function (version) {
            this.version = version;
        };
        Programa_1.prototype.getVersion = function () {
            return this.version;
        };
        return Programa_1;
    }());
    __setFunctionName(_classThis, "Programa");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        Programa = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Programa = _classThis;
}();
